...
const Updatepage = () => {
    ...
    const updatehandler=(e)=>{
        ...
        const objectdata=Object.fromEntries(fromdata.entries())
        console.log(objectdata)
        fetch(`/api/updatecoffee/${data._id}`,{
            method:"PUT",
    ...
    <form onSubmit={updatehandler} class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name='supplier'                defaultValue={data.supplier} 
                           class="w-full text-2xl text-black px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"/>
                </div>
                <div>
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text"  name='Chef' defaultValue={data.Chef}
                           class="w-full text-2xl text-black px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"/>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Taste</label>
                    <input type="text"  name="taste" defaultValue={data.taste}
                           class="w-full text-2xl text-black px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"/>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <input name='photoUrl' type="url" defaultValue={data.photoUrl}
                   class="w-full text-2xl text-black px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"/>
        </div>
